...
DEV_HUB_USERNAME="moma_prod"
DEV_USERNAME="moma_src"
STAGING_USERNAME="moma_trg"
PROD_USERNAME="moma_ctrl"

# Repository with your code
GITHUB_REPO="thombehrens/salesforce-dx-pipeline-mdapi-sample"
